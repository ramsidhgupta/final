...
//   useEffect(() => {
//     backgroundRef.current.style.background = `linear-gradient(rgba(0, 0, 0, .3), rgba(0, 0, 0, .3)), url(${CardData.image})`;
...
//       "transform .6s cubic-bezier(.4,.2,.2,1), transform-style 2s";
//   }, [CardData.image]);

  return (
    <>
        <div className="section" style={{marginLeft:"-1.75rem"}} >
    <div className="MainContainer d-flex align-items-center" style={{height:"100vh", width:"100vw"}}>
      <div className="card-container mx-4 my-4">
