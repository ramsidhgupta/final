...
const CpuGpu = () => {
  ...
  const TechData = [
    ...
    },
    {
      ...
      title: "Logic blocks consisting of macro cells",
    },
    {
      id: 5,
      svg: (
  ...
  return (
    <>
      <section class="wrapper-border bg-light mt-5">
        <BannerZoom images={images} heading1={heading1}/>
      </section>
      <section class="wrapper-border bg-light mt-4">
        <div class="container py-10 py-md-10">
          ...
          <motion.div 
            ...
            <div class="col-md-5 mb-1 mt-4" style={{color:"#407AFF"}}>
              <motion.p className="lead fw-bold"  
                ref={ref}
                initial="hidden"
                animate={inView ? "visible" : "hidden"}
                variants={variants1}
           ...
           Analog and Mixed-Signal Chip designs bring challenges for many aspects of electronics system development. Optimal sizing and/or value of devices – transistors, resistors, capacitors within an IC is an art and science both. This needs to meet the functional and power requirements of the system at an optimal schedule and cost which requires a deep understanding of the device physics along with the model parameters of the process node.
              ...
              <motion.p className="lead fw-bold"
                ...
                transition={{ duration: 2 }}>
                       ...
                       In order to meet the highest standard of requirement, Techsoc significantly invests in its analog engineers to establish their strength in fundamentals of analog design, specializes in specific domains, and invests in processes, methodologies, the best practices, and infrastructure, like EDA Tools and machines. Such an intrinsic disciplined culture helps in maximum productivity with minimum cost.
          ...
          style={{color:"#407AFF"}}
            ...
            <h2 >Our Analog Design includes the following</h2>
        </div>
        <hr class="double my-10" />  
          ...
          >
            <div className="col-lg-3">
              <AsicCard Data={TechData[6]} />
            </div>
            <div className="col-lg-3">
              <AsicCard Data={TechData[7]} />
            </div>
            <div className="col-lg-3">
              <AsicCard Data={TechData[8]} />
            </div>
            <div className="col-lg-3">
              <AsicCard Data={TechData[9]} />
            </div>
          </div>
          <hr class="double my-8" />
          <div
