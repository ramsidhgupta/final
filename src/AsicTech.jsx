...
import chip2 from "./assets/ai_board_2.jpg";
import chip3 from "./assets/ai_board_3.jpg";
import animation1 from "./lottieFiles/ram/Animation - 1711812586610.json";
import BackGround from "./lottieFiles/BackGround1.json";
...
const AsicTech = () => {
  ...
  const TechData = [
    ...
    },
    {
      ...
      title: "Spyglass/Xilinx/Vivado Etc.",
    },
    {
      id: 5,
      svg: (
    ...
    },
    {
      ...
      title: "Clock Domain Crossing Analysis",
    },
    {
      id: 7,
      svg: (
      ...
      title: "Area/Power optimizations",
    },
  ];
  return (
    <>
      ...
      <section class="wrapper-border mt-4">
        ...
        <div class="container py-10 py-md-10">
          <motion.div
            ...
            className="card ms-lg-13 mt-1 mb-3 DV-at"
          >
            <div className="card-body">
              <div className="d-flex flex-row">
                <p
                  className="lead fw-bold text-center downtoup"
                  style={{
                    lineHeight: "1.4",
                    letterSpacing: "2px",
                    fontSize: "1.5rem",
          ...
          <div class="row">
            <motion.div
              ...
              className="col-md-5 col-lg-5 mb-1"
            >
              <Player
                src={animation1}
                className="player"
            ...
            <motion.div
              ref={ref3}
              initial="initial"
              animate={inView3 ? "visible" : "initial"}
              variants={variants1}
              transition={{ duration: 1, delay: 1 }}
              className="col-md-7 col-lg-7 mb-1"
              style={{ color: "#407AFF" }}
            >
              <div
                className="card RTL-at"
                style={{
                  borderRadius: "10px",
              ...
              >
                <div className="card-body">
                  <h4 className="raamm">OUR RTL DESIGN EXPERTISE </h4>
                  <ul className="fw-bold ramParagraph">
                    <li>
                      At TechsoC we involve designing Application-Specific
                      Integrated Circuits (ASICs) or Register Transfer Level
                      (RTL) designs.
                    </li>
                    <br />
                    <li>
                      Our design engineers typically focuses on designing
                      integrated circuits for specific applications, optimizing
                      them for performance, power, and area.
                    </li>
                    <br />
                    <li>
                      We describing the behavior of a digital system at the
                      register-transfer level using hardware description
                      languages such as Verilog, VHDL, or SystemVerilog.
                    </li>
                    <br />
                    <li>
                      We work on specifying the logic and interconnections of
                      digital circuits, including processors, controllers, and
                      interfaces.
                    </li>
                    <br />
                    <li>
                      Our RTL engineers optimize designs for performance, power
                      consumption, and area constraints.
                    </li>
                    <br />
                    <li>
                      Techsoc ASIC/RTL designers collaborate closely with
                      architects, system engineers, verification engineers, and
                      physical design engineers throughout the design process.
                    </li>
                    <br />
                    <li>
                      In Techsoc we use industry-standard tools and
                      methodologies for design, verification, synthesis, timing
          ...
          <motion.div
            ref={ref4}
            initial="initial"
            animate={inView4 ? "visible" : "initial"}
            variants={variants3}
            transition={{ duration: 0.5, delay: 0.2 }}
            style={{ color: "#407AFF" }}
            className="d-flex justify-content-center align-items-center mt-0 overflow-auto"
          >
            <h2 className="text-white">Our RTL Design suite includes the following</h2>
          </motion.div>
          <hr class="double my-10" />
          <motion.div
            ref={ref5}
            initial="initial"
            animate={inView5 ? "visible" : "initial"}
            variants={variants3}
            transition={{ duration: 0.7, delay: 0.5 }}
            className="row gy-3 gx-xl-8"
          >
